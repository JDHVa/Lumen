...
Hoy **no hay pantalla para cambiar contraseñas ni para recuperarlas**. Si
alguien la pierde, hay que crearle otra cuenta o cambiarla en la base a mano.
Es lo primero que conviene construir después de esto.
