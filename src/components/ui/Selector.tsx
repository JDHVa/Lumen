...
export function Selector({
  ...
  return (
    <label className="flex w-full min-w-0 flex-col gap-1.5">
      ...
      <select
        className={[
          "w-full min-w-0 min-h-[48px] appearance-none rounded-suave border border-marino/20 bg-white px-4 py-3 text-base text-tinta transition-colors duration-150",
...
export function AreaTexto({
  ...
  return (
    <label className="flex w-full min-w-0 flex-col gap-1.5">
      ...
      <textarea
        className={[
          "w-full min-w-0 min-h-[9rem] rounded-suave border border-marino/20 bg-white px-4 py-3 text-base leading-relaxed text-tinta transition-colors duration-150",
